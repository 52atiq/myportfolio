        ...
        <nav className='bg-[#0F172A]'>
            <div className='flex items-center font-semibold justify-around'> 
                <div className='z-50 p-5 md:w-auto w-full flex justify-between '>
                    <h1 className='text-amber-600 md:cursor-pointer uppercase md:border-b-2 hover:bg-amber-900 hover:text-white md:hover:border-t-2 px-4'>Atiqur Rahman</h1>
                ...
                <ul className='md:flex hidden text-white  uppercase items-center gap-8 '>
                    <li>
                        <Link to='/' className='py-7 px-3 inline-block hover:text-amber-600'>Home</Link>
                    </li>
                    <NavLinks />
                </ul>
